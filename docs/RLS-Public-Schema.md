...
-- WORKSPACE TABLE
-- ========================================================
DROP POLICY IF EXISTS "Workspace: select by membership" ON "Workspace";
CREATE POLICY "Workspace: select by membership" ON "Workspace"
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM "OrganizationMember" m
...
DROP POLICY IF EXISTS "Workspace: insert by membership" ON "Workspace";
CREATE POLICY "Workspace: insert by membership" ON "Workspace"
  FOR INSERT WITH CHECK (
    EXISTS (
      SELECT 1 FROM "OrganizationMember" m
      WHERE m."organizationId" = "Workspace"."organizationId"
...
DROP POLICY IF EXISTS "Workspace: update by membership" ON "Workspace";
CREATE POLICY "Workspace: update by membership" ON "Workspace"
  FOR UPDATE USING (
    EXISTS (
      SELECT 1 FROM "OrganizationMember" m
      WHERE m."organizationId" = "Workspace"."organizationId"
...
DROP POLICY IF EXISTS "Workspace: delete by owner_or_admin" ON "Workspace";
CREATE POLICY "Workspace: delete by owner_or_admin" ON "Workspace"
  FOR DELETE USING (
    EXISTS (
      SELECT 1 FROM "OrganizationMember" m
      WHERE m."organizationId" = "Workspace"."organizationId"
...
CREATE POLICY "Service role has full access" ON "Workspace" FOR ALL USING (auth.role() = 'service_role');
